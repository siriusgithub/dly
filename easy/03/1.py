...
if cry == 'd':
   ...
   # FILE OR PASTE
   print("\nDo you have a file to decrypt (f) or ready to paste the message to decrypt (p)?")
   typ = input()
   ...
   if typ == 'f':
      ...
      # YES
      if sav == 'y':
         print("\nPress enter to save to the current path or give a new path: ")
         savpat = input()
...
# ENCRYPT
     ...
     # FILE OR PASTE
     print("\nDo you have a file to encrypt (f) or ready to paste the message to encrypt (p)?")
     typ = input()
