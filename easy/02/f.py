...
while True:
      ...
      # PROMPT USER ASKING WHICH VALUE TO FIND, ASSUMES USER ALREADY KNOWS THE REST OF THE VALUES EXCEPT FOR THE ONE UNKNOWN
           ...
           print("\nWhat would you like to find? Interest (int), initial amount of money (ini), the rate of interest (rat), the time spent investing (tim), or how many times the interest is applied per year (per)?") 
           fin = input()
      ...
      # PROMPT USER ASKING WHICH VALUE TO FIND, ASSUMES USER ALREADY KNOWS THE REST OF THE VALUES EXCEPT FOR THE ONE UNKNOWN
           ...
           print("\nWhat would you like to find? Total (tot), initial amount of money (ini), the rate of interest (rat), or the time spent investing (tim)? You cannot find out how many times the interest is applied per year unfortunently.") 
           fin = input()
