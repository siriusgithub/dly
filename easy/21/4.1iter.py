...
# 342
# 5342
# 8888999977773333444455551111222233332222
...
def nextPermutation(givenNumber):
    ...
    for aindex in range(len(digitList)):
        ...
        for bindex in range(aindex, len(digitList)):
            ...
            # MAYBE USE A SORTED LIST FOR bindex?
            # WE NEED TO COMPARE SEPERATED PLACES, CURRENTLY THE IF STATEMENT ONLY DOES THE FOLLOWING:
